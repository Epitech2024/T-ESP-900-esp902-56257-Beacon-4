...
"#ifndef PROTOCOL_VERSION_H`n`#define PROTOCOL_VERSION_H`n`const char *protocolVersion = `"$protocol_version`";`n`#endif /* PROTOCOL_VERSION_H */" | Out-File '.\DeviceFirmware\Arduino_Firmware_src\src\protocol\protocolversion.h'
...
"#ifndef PROTOCOL_VERSION_H`n`#define PROTOCOL_VERSION_H`n`const char *protocolVersion = `"$protocol_version`";`n`#endif /* PROTOCOL_VERSION_H */" | Out-File '.\GatewayFirmware\Arduino_Firmware_src\src\protocol\protocolversion.h'
